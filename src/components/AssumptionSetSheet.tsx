          ...
          <div className="flex flex-col gap-5 px-6 py-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <NumInput
                ...
                field="federalTaxRate"
              />
              <NumInput
                id="landValuePrcnt"
                label="Land Value %"
                field="landValuePrcnt"
              />
            </div>
            <div className="flex flex-col gap-1">
            ...
            >
              ...
              <TabsContent value="LTR" className="mt-5 flex flex-col gap-5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  />
                  <NumInput
                    id="repairSavingsRate"
                    label="Repair Savings Rate"
                    field="repairSavingsRate"
                  />
                  <NumInput
                    id="capexReserveRate"
                    label="CapEx Reserve Rate"
                    field="capexReserveRate"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <NumInput
                    ...
                    field="sellingCostsRate"
                  />
                  <NumInput
                    id="longtermCapitalGainsTaxRate"
                    label="LT Capital Gains Rate"
                    field="longtermCapitalGainsTaxRate"
                  />
                  <NumInput
                    id="residentialDepreciationPeriodYrs"
                    label="Depreciation Period (yrs)"
                    field="residentialDepreciationPeriodYrs"
                  />
                  <NumInput
                    id="defaultPropertyConditionScore"
                    label="Property Condition Score"
                    field="defaultPropertyConditionScore"
                  />
                  <NumInput
                  ...
                  />
                  <NumInput
                    id="mfAppreciationRateOverride"
                    label="MF Appreciation Override"
                    field="mfAppreciationRateOverride"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <NumInput
                    id="utilityElectricBase"
                    label="Electric"
                    field="utilityElectricBase"
                  />
                  <NumInput
                    id="utilityGasBase"
                    label="Gas"
                    field="utilityGasBase"
                  />
                  <NumInput
                    id="utilityWaterBase"
                    label="Water"
                    field="utilityWaterBase"
                  />
                  <NumInput
                    id="utilityTrashBase"
                    label="Trash"
                    field="utilityTrashBase"
                  />
                  <NumInput
                    id="utilityInternetBase"
                    label="Internet"
                    field="utilityInternetBase"
                  />
                  <NumInput
                    id="utilityBaselineSqft"
                    label="Baseline Sqft"
                    field="utilityBaselineSqft"
                  />
                </div>
              </TabsContent>
              ...
              <TabsContent value="FLIP" className="mt-5 flex flex-col gap-5">
                <div className="grid grid-cols-2 gap-3">
                  <NumInput
                    id="rehabContingencyPct"
                    label="Rehab Contingency %"
                    field="rehabContingencyPct"
                  />
                  <NumInput
                    id="holdingCostRateMonthly"
                    label="Holding Cost Rate (mo.)"
                    field="holdingCostRateMonthly"
                  />
                  <NumInput
                    id="flipSellingCostsRate"
                    label="Selling Costs Rate"
                    field="flipSellingCostsRate"
                  />
                  <NumInput
                    id="shorttermCapitalGainsRate"
                    label="ST Capital Gains Rate"
                    field="shorttermCapitalGainsRate"
                  />
                  <NumInput
                    id="minRoiPct"
                    label="Min ROI %"
